...
{
    /// <summary>
    /// Аудиофайл, который будет рассматриваться как музыка для отправки.
    /// <see href="https://core.telegram.org/bots/api#inputmediaaudio"/>
    /// </summary>
    public class InputMediaAudio
    {
        /// <summary>
        /// тип результата, должно быть «audio»
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Необязательный. Заголовок аудио для отправки, до 1024 символа
        /// </summary>
        [MaxLength(1024)]
        ...
        /// <summary>
        /// Необязательный. Длительность звука в секундах
        /// </summary>
        public int Duration { get; set; }

        /// <summary>
        /// Необязательный. Исполнитель аудио
        /// </summary>
        public int Performer { get; set; }

        /// <summary>
        /// Необязательный. Название аудио
        /// </summary>
